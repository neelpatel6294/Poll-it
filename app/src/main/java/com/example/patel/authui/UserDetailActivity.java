...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        final FloatingActionButton followUserFab = findViewById(R.id
                .follow_user_fab);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    followUserFab.setImageDrawable(ContextCompat.getDrawable(
                            UserDetailActivity.this, R.drawable.ic_baseline_home_24px));
                } else {
                    followUserFab.setImageDrawable(ContextCompat.getDrawable(
                            UserDetailActivity.this, R.drawable.ic_baseline_person_outline_24px));
                }
            }
...
//                                                    firebaseError.getMessage());
        ...
        mRecyclerGrid = findViewById(R.id.user_posts_grid);
        ...
        mPersonInfoListener = mPersonRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                CircleImageView userPhoto = findViewById(R.id.user_detail_photo);
